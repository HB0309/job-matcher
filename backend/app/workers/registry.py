...
from app.workers.connectors.hiringcafe import HiringCafeConnector
from app.workers.connectors.indeed import IndeedConnector
...
_REGISTRY: dict[str, BaseConnector] = {
    ...
    "hiringcafe": HiringCafeConnector(),
